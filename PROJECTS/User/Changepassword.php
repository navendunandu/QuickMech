...
<form id="form1" name="form1" method="post" action="">
  <table width="324" height="116" border="1" align="center">
    <tr>
      <td width="175">Current Password</td>
      <td width="85"><label for="txtcurrennt"></label>
      <input type="text" name="txtcurrennt" id="txtcurrennt" title="Must contain at least one number  and at least6 or more characters" /></td>
    </tr>
    <tr>
      <td>New Password</td>
      <td><label for="txtnew"></label>
      <input type="text" name="txtnew" id="txtnew" title="Must contain at least one number  and at least6 or more characters" /></td>
    </tr>
    <tr>
      <td>Comfirm Password</td>
      <td><label for="txtconfirm"></label>
      <input type="text" name="txtconfirm" id="txtconfirm" title="Must contain at least one number  and at least6 or more characters" /></td>
    </tr>
    <tr>
