...
<form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
  <table width="375" height="109" border="1" align="center">
  
   <tr>
      <td width="97" height="23">Name</td>
      <td width="145"><label for="txtname"></label>
      <input type="text" name="txtname" id="txtname" value= "<?php echo $rowUser["user_name"]?>" title="Name Allows Only Alphabets,Spaces and First Letter Must Be Capital Letter" pattern="^[A-Z]+[a-zA-Z ]*$"/>        </td>
    </tr>
    <tr>
      <td height="23">Contact</td>
      <td><label for="txtcontact"></label>
      <input type="text" name="txtcontact" id="txtcontact" value="<?php echo $rowUser["user_contact"]?>"title="Phone number with  10 digit from 0-9" />         </td>
    </tr>
    <tr>
