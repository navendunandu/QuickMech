...
<form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
  <table width="375" height="288" border="1" align="center">
  
   <tr>
     <td colspan="2" align="center"><img src="../Assets/Files/UserDocs/<?php echo $rowUser["user_photo"]?>" width="100" height="100" /></td>
    </tr>
   <tr>
      <td>District</td>
